...
document.getElementById("inner").innerHTML = "JavaScript Can Change HTML Content and CSS Style innerHTML";
...
var num2 = 14;
var string = "30";
var _firstName= "Abdul ", _lastName= 'Ali';//private variable, multiple variable
...
var x = 10;
var y = 2;
document.getElementById('sub').innerHTML = "Subtraction of   x and y: "+(x-y);
document.getElementById('product').innerHTML = "Multiplication of   x and y: "+(x*y);
document.getElementById('division').innerHTML = "Division of   x and y: "+(x/y);
document.getElementById('modulus').innerHTML = "Modulus of   x and y: "+(x%y);
document.getElementById('power').innerHTML = "Exponentiation of   x and y: "+(x**y);
document.getElementById('power_func').innerHTML = "Exponentiation of   x and y by function: "+Math.pow(x,y);
...
//Array
var ledp = ['Graphics Design', 'Digital marketing', 'Web Design and Development'];
document.write("All LEDP Free Course gifted by prime minister: "+ledp+"<br/>");
document.write("First 0 index of this array: "+ledp[0]+"<br/>");

//Object
var trainee1 ={name: 'Abdul Alim',batch: 'lot-6', trainer: 'Md Shofiqul Islam', course: 'Web Design and Development'};
...
document.write("'3' is "+typeof '3'+"<br /> <em><strong><mark><kbd>Hi</kbd></mark></strong></em><br />");
document.write("Empty is "+typeof ""+"<br />");
document.write("Empty is "+typeof ''+"<br />");
document.write("Not declared variable is "+typeof type0+"<br />");
document.write("Null is "+typeof null+" ..Mistake of JavaScript. It should be Null<br />");
document.write("Array is "+typeof ledp+" !!!!<br />");
document.write("Object is "+typeof trainee1+"<br />");
document.write(typeof (0==0)+"<br />");
document.write(typeof (0!=0)+"<br />");
document.write("Function data Type is "+typeof function ledp2020(){}+"<br />");
...
//Object
var person = {firstName:"Abdul", lastName :"Alim", trainer :"Md Shafiqul Islam", age:23};
...
var octal = 021;//0 can define Octal in some javascript version
...
"32 = " + " " + 
" Decimal " + myNumber2.toString(10) + "<br>" +
" Hexadecimal " + myNumber2.toString(16) + "<br>" +
" Octal " + myNumber2.toString(8) + "<br>" +
" Binary " + myNumber2.toString(2);
...
var friends = ['Farhad', 'Rumman', 'Rafit', 'sakib', 'Munem', 'Maruf', 'Avi', 'Jahid', 'basu', 'Robiul', 'Taha', 'Sajon'];//Good declaration
...
document.write("<li><br />Picked from array the full named month: "+months[d.getMonth()]+"<br /></li>");
...
document.write("<li><br />Picked from array the full named month: "+days[d.getDay()]+"<br /></li>");
document.write("</ul>");
...
{
	document.getElementById('date').innerHTML = "Hurrah!! its holiday. Give your time to your family. Don't miss Zummah Salah! &#128525";
	
}
else if(today.getHours()>=5 && today.getHours()<9){
	document.getElementById('date').innerHTML = "Good Morning!Your LEDP training will start at 9 am. Have a good day! &#128525";
}
else if(today.getHours()>=9 && today.getHours()<11){
	document.getElementById('date').innerHTML = "Hey guys, Good Morning! Looks like you are in LEDP training now. Be attentive in your class. &#128525";
}
else if(today.getHours()>=11 && today.getHours()<13){
	document.getElementById('date').innerHTML = "Hey guys, Good Noon! Looks like you are in LEDP training now. Be attentive in your class. Don't forget your Zahar Salah! &#128525";
}
else if(today.getHours()>=13 && today.getHours()<15){
	document.getElementById('date').innerHTML = "Hey guys, Good Noon! Looks like you finished todays LEDP training. Rest some time. Don't forget your Acor Salah! &#128525";
}
else if(today.getHours()>=16 && today.getHours()<19){
	document.getElementById('date').innerHTML = "Good Afternoon! Time to practice your assignments. &#128525";
}
else if(today.getHours()>=19 && today.getHours()<21){
	document.getElementById('date').innerHTML = "Time to see your favourate drama Kosem Sultan. &#128151&#128516";
}
else if(8.30>=today.getHours()<1){
	document.getElementById('date').innerHTML = "Good Night! Remember your Isha salah and LEDP's Assignment. Don't use facebook very much. &#128525";
}
else{
	document.getElementById('date').innerHTML = "What are you doing here?, Its night here. So slep, buddy. Don't Dream, just sleep peacefully. Don't forget your Fazar Salah. &#128525";
}
...
document.write("<br />Math.sin: The sine value of 90 degree is "+Math.sin(90*Math.PI/180));//Returns 1
document.write("<br />Math.cos: The cos value of 0 degree is "+Math.cos(0*Math.PI/180));//Returns 0
...
document.write("<br /><h2>Random Numbers: </h2><br />"+ Math.floor(Math.random() * 100));//Between 0 to 99
...
function getRndInteger(min, max) {
  ...
  document.write("<br />Random Number by proper function: "+getRndInteger(100, 1000));
...
loop1:
for (p = 0; p < 3; p++) {      //The first for statement is labeled "loop1"
   loop2:
   for (q = 0; q < 3; q++) {   //The second for statement is labeled "loop2"
      if (p === 1 && q === 1) {
         continue loop1;
      }
...
var secondListItem = document.querySelector('#another-unorder-list').querySelector('.item:nth-child(2)');
